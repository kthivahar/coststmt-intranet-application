...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, sg.gov.tech.sao.customs.intranet.coststmt.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, sg.gov.tech.sao.customs.intranet.coststmt.repository.UserRepository.USERS_BY_EMAIL_CACHE);
